...
_C.PANOPTIC.SMALL_OBJECT_DIAG_THRESH = 0 # Threshold for objects to be treated as SMALL objects TODO: enable
_C.PANOPTIC.SMALL_OBJECT_IOU_THRESH = 0.3 # IoU threshold used on SMALL objects
